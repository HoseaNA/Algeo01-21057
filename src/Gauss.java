 ...
 * **/
    ...
    public static boolean isOneLeadElmt(int i, MATRIKS M){
        ...
        //F.S : Mengembalikan nilai true jika Matriks M baris ke-i hanya memiliki satu leadElement
        boolean value = true;
    ...
    public static int leadElmtIndex(int i, MATRIKS M){
        //I.S Mengecek Matriks M baris indeks ke-i, Matriks M berbentuk rowEchelon/ReducedRE
